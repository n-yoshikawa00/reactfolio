                    ...
                    <div className="text-center flex flex-wrap justify-center lg:text-left lg:block">
                      ...
                      >
                        <tr className="h-15">
                          ...
                          <td className="flex  justify-center items-center flex-wrap gap-3">
                            <div className="badge py-4">JavaScript</div>
                            <div className="badge py-4">HTML</div>
                            <div className="badge py-4">CSS</div>
                          </td>
                        </tr>
                        <tr className="h-15">
                          ...
                          <td className="flex flex-wrap gap-3">
                            <div className="badge py-4">tailwindcss</div>
                            <div className="badge py-4">react</div>
                            <div className="badge py-4">JSF</div>
                            <div className="badge py-4">JUnit</div>
                          </td>
                        </tr>
                        <tr className="h-15">
                          <th className="text-left py-4">開発環境</th>
                          <td className="flex flex-wrap gap-3">
                            <div className="badge py-4">IntelliJ IDEA</div>
                            <div className="badge py-4">VSCode</div>
                            <div className="badge py-4">Docker</div>
                          </td>
                        </tr>
                      </table>
